...
type Message struct {
	...
	User      string `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`            // The name of the user sending the message
	Text      string `protobuf:"bytes,2,opt,name=text,proto3" json:"text,omitempty"`            // The content of the message
	Timestamp int64  `protobuf:"varint,3,opt,name=timestamp,proto3" json:"timestamp,omitempty"` // The time the message was sent, in milliseconds since epoch
}
...
var file_proto_chat_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x04, 0x63, 0x68, 0x61, 0x74, 0x22, 0x4f, 0x0a, 0x07, 0x4d, 0x65, 0x73, 0x73,
	...
	0x74, 0x69, 0x6d, 0x65, 0x73, 0x74, 0x61, 0x6d, 0x70, 0x32, 0x37, 0x0a, 0x0b, 0x43, 0x68, 0x61,
	0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x28, 0x0a, 0x04, 0x43, 0x68, 0x61, 0x74,
	...
	0x30, 0x01, 0x42, 0x13, 0x5a, 0x11, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x63, 0x68, 0x61, 0x74,
